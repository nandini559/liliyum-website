    ...
    <section className="py-16 sm:py-24 bg-amber-200 text-[#3B1C10] w-full max-w-full overflow-hidden relative select-none border-t border-[#EAE0D5]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10">
        ...
        <div className="text-center">
          <Link to="/menu" className="inline-flex items-center gap-2 bg-[#3B1C10] hover:bg-[#28120A] text-[#FAF3EA] px-8 py-3.5 rounded-full font-serif font-bold text-base shadow-xl transition-all duration-300 transform hover:-translate-y-0.5">
