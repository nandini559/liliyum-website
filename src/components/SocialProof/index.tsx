...
export const SocialProof: React.FC = () => {
  const reviews = [
    ...
    },
    {
      ...
      caption: "Belgian Truffle Unboxing",
      rotation: "rotate-3"
    },
    {
      id: 3,
    ...
    },
    {
      ...
      caption: "Blueberry Cheesecake Tasting",
      rotation: "rotate-4"
    },
    {
      id: 5,
    ...
    },
    {
      ...
      caption: "Royal Rose & Pistachio Slice",
      rotation: "rotate-2"
    },
    {
      id: 7,
  ...
  return (
    <section className="py-20 sm:py-28 bg-[#FDE7DA] text-[#3B2C27] w-full max-w-full overflow-hidden select-none relative">
      ...
      <div className="text-center max-w-3xl mx-auto mb-16 sm:mb-20 px-4">
        <h2 className="font-serif text-5xl sm:text-6xl md:text-7xl font-black text-[#F05D5E] tracking-wider uppercase mb-3 drop-shadow-sm">
          FLAVOR TALKS
        </h2>
