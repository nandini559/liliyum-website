...
export const CTASection: React.FC = () => {
  return (
    <section className="py-20 bg-gradient-to-r from-[#2D2422] via-[#3D2E2B] to-[#2D2422] text-[#FAF7F5] relative overflow-hidden w-full max-w-full">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10 w-full">
        ...
        <h2 className="font-serif text-3xl sm:text-5xl font-bold text-white mb-6 leading-tight">
          Ready to Add a <span className="text-[#D4A373] italic">Lil' Yum</span> to Your Celebration?
        </h2>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 max-w-md mx-auto mb-10 w-full">
          ...
          <a
            ...
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2.5 bg-white/10 hover:bg-white/20 text-[#EAD5BE] border border-[#5C483F] px-4 sm:px-7 py-4 rounded-2xl font-semibold text-xs sm:text-sm transition-all duration-300 max-w-full"
          >
