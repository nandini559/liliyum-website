...
const CategoryPage: React.FC = () => {
    ...
    return (
        <section className="relative w-full bg-amber-100 py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8">
          ...
          ====================================================== */}
                    ...
                    >
                        <div className="w-full sm:w-1/2 h-56 sm:h-full min-h-[220px] relative overflow-hidden rounded-2xl">
                            <img
                                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSpT4MoVKnDvcXoZKGWWvmE69pLRcQ9pL6rMzcjbsdoNw&s=10"
                        ...
                        <div className="w-full sm:w-1/2 text-white space-y-3 z-10">
                            ...
                            <p className="text-xs sm:text-sm text-gray-300 font-normal leading-relaxed">
                                Fruity flavours paired with our signature glaze-dipped
                                signature pastries baked fresh daily.
                            </p>
                    ...
                    >
                        <div className="relative z-10 space-y-2 flex flex-col items-center">
                            ...
                            <p className="text-xs text-white font-medium max-w-[200px]">
                                Fluffy Madagascar vanilla sponge topped with Belgian
                                buttercream swirl.
                            </p>
                    ...
                    >
                        <div className="space-y-3 z-10">
                            ...
                            <p className="text-xs text-gray-300 leading-relaxed">
                                Rich 70% dark cocoa layer cake topped with silken chocolate
                                ganache and roasted hazelnuts.
                            </p>
                        </div>
                        ...
                        <button
                            type="button"
                            onClick={() => navigate("/menu")}
                            className="mt-3 text-xs font-extrabold text-white hover:underline cursor-pointer text-left"
                        >
                            Order Now →
                        </button>
                    ...
                    >
                        <div>
                            ...
                            <p className="text-xs text-white mt-1">
                                French almond meringue shells filled with raspberry,
                        ...
                        <div className="mt-1 relative h-44 w-full overflow-hidden rounded-2xl">
                            <img
                                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQCK01Op-EcXbeRNzlSt3n1ogE3ckEDC4P1FXeL33wdkA&s=10"
                                alt="Macarons"
          ...
          ====================================================== */}
                    ...
                    >
                        <div>
                            ...
                            <p className="text-xs text-white mt-1">
                                Flaky butter croissants filled with dark chocolate ganache
                                and amarena cherry glaze.
                            </p>
                        </div>
                        ...
                        <div className="mt-4 relative h-44 w-full overflow-hidden rounded-2xl">
                            <img
                                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT4qgPF2oyXiZFDpdVQ7elDHK-KJqZtKzzGFeJBP27hWQ&s=10"
