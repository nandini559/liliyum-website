...
export const CategorySection: React.FC = () => {
  ...
  return (
    <section className="py-16 sm:py-24 bg-[#EBE3F2] text-[#2E1D44] w-full max-w-full overflow-hidden relative select-none">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16">
          <div className="inline-flex items-center gap-2 bg-[#DED2EB] text-[#2E1D44] px-4 py-1 rounded-full text-xs font-semibold uppercase tracking-widest mb-3 border border-[#CBB8DE]">
            <Sparkles className="w-3.5 h-3.5 text-[#6B3FA0]" />
            <span>Shop by Occasion & Indulgence</span>
          </div>
          <h2 className="font-serif text-4xl sm:text-5xl md:text-6xl font-black text-[#2E1D44] tracking-tight">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12 relative">
          ...
          <div className="hidden xl:flex flex-col items-center justify-between py-8 text-[11px] font-semibold tracking-widest text-[#2E1D44]/70 uppercase space-y-12 shrink-0 border-r border-[#D3C3E3] pr-6">
            ...
            <div className="flex flex-col items-center gap-12 rotate-180 [writing-mode:vertical-lr]">
              <span className="hover:text-[#2E1D44] cursor-pointer transition-colors">RESERVE A TABLE</span>
              <span className="hover:text-[#2E1D44] cursor-pointer transition-colors flex items-center gap-2">
                MENU <span className="w-1.5 h-1.5 rounded-full bg-[#2E1D44]" />
              </span>
              <span className="hover:text-[#2E1D44] cursor-pointer transition-colors">CONTACTS</span>
            </div>
          ...
          <div className="flex-1 w-full grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="flex flex-col items-center lg:items-start relative group">
              ...
              <div className="relative flex items-center justify-center my-6">
                <Link to="/collection?category=cheesecakes-tarts" className="block relative z-10">
                  <img
                    ...
                    alt="Citrus Tart"
                    className="w-60 h-60 sm:w-72 sm:h-72 md:w-80 md:h-80 rounded-full object-cover shadow-2xl border-4 border-white/80 transition-transform duration-500 group-hover:scale-105"
                  />
                </Link>
                ...
                <svg
                  viewBox="0 0 400 400"
                  className="absolute -top-10 -left-10 w-[300px] h-[300px] sm:w-[360px] sm:h-[360px] md:w-[400px] md:h-[400px] pointer-events-none z-20"
                >
                  <path
                    id="curveCitrus"
                  ...
                  <text className="font-serif text-3xl sm:text-4xl md:text-5xl font-black fill-[#2E1D44] tracking-widest uppercase">
                    <textPath href="#curveCitrus" startOffset="50%" textAnchor="middle">
                      CITRUS TART
                    </textPath>
                  </text>
                </svg>
              ...
              <div className="max-w-xs text-center lg:text-left mt-2">
                <div className="flex items-baseline justify-center lg:justify-start gap-2 mb-1.5">
                  ...
                  <span className="text-xs text-[#2E1D44]/60 font-semibold">({categories[0].price})</span>
                </div>
                <p className="text-[11px] sm:text-xs text-[#2E1D44]/80 leading-relaxed font-medium uppercase tracking-wider mb-3">
                  {categories[0].desc}
                </p>
                <Link
                  to="/collection?category=cheesecakes-tarts"
                  className="inline-flex items-center gap-1.5 text-xs font-bold text-[#2E1D44] underline hover:text-[#6B3FA0] transition-colors"
                >
            ...
            <div className="flex flex-col items-center lg:items-end relative group">
              ...
              <div className="max-w-xs text-center lg:text-right mb-4 order-2 lg:order-1">
                <div className="flex items-baseline justify-center lg:justify-end gap-2 mb-1.5">
                  ...
                  <span className="text-xs text-[#2E1D44]/60 font-semibold">({categories[1].price})</span>
                </div>
                <p className="text-[11px] sm:text-xs text-[#2E1D44]/80 leading-relaxed font-medium uppercase tracking-wider mb-3">
                  {categories[1].desc}
                </p>
                <Link
                  to="/collection?category=jar-cakes"
                  className="inline-flex items-center gap-1.5 text-xs font-bold text-[#2E1D44] underline hover:text-[#6B3FA0] transition-colors"
                >
              ...
              <div className="relative flex items-center justify-center my-4 order-1 lg:order-2">
                ...
                <svg
                  viewBox="0 0 400 400"
                  className="absolute -top-10 -right-10 w-[300px] h-[300px] sm:w-[360px] sm:h-[360px] md:w-[400px] md:h-[400px] pointer-events-none z-20"
                >
                  <path
                    id="curveRaspberry"
                    d="M 60,200 A 140,140 0 0,1 340,200"
        ...
        <div className="mt-16 pt-8 border-t border-[#D3C3E3] flex flex-wrap items-center justify-center gap-3">
          {categories.map((cat) => (
            <Link
              ...
              className="px-5 py-2.5 rounded-full bg-white/70 hover:bg-white text-[#2E1D44] font-serif font-bold text-sm shadow-sm hover:shadow-md transition-all border border-[#D3C3E3]"
            >
              {cat.name}
            </Link>
          ))}
